 ...
 * 
 */
@WebFault(name = "FileNotFoundException", targetNamespace = "http://impl.slave.assignment3.pcsd.diku.dk/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: dk.diku.pcsd.assignment3.slave.impl.FileNotFoundException
     */
