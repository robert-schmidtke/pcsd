 ...
 * 
 */
@WebFault(name = "KeyNotFoundException", targetNamespace = "http://impl.master.assignment3.pcsd.diku.dk/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: dk.diku.pcsd.assignment3.master.impl.KeyNotFoundException
     */
