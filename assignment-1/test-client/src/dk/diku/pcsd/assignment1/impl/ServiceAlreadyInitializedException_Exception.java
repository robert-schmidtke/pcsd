 ...
 * 
 */
@WebFault(name = "ServiceAlreadyInitializedException", targetNamespace = "http://impl.assignment1.pcsd.diku.dk/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: dk.diku.pcsd.assignment1.impl.ServiceAlreadyInitializedException
     */
